...
@section('content')
    <div class="container my-4">
        <form action="{{ route('filem.update', $filem->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-9">
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3">
                                <label for="namaJudul" class="form-label">Judul Filem</label>
                                <input type="text" name="judul" class="form-control" value="{{ $filem->judul }}"
                                    id="namaJudul">
                                @error('judul')
                ...
                <div class="col-md-3">
                            ...
                            <div class="mb-3">
                                <div class="card shadow-none border text-center ">
                                    <label class="form-label border-dashed cursor-pointer" id="label"
                                        ...
                                        <img src="{{ asset('img/gambar/' . $filem->gambar) }}" id="plusimg"
                                            class="img-fluid p-md-3" alt="">
                                        <input accept="image/*" type="file" name="gambar" value="{{ $filem->gambar }}"
                    ...
                    <div class="text-end">
                        <a href="/filem" class="btn btn-secondary">Cancel</a>
