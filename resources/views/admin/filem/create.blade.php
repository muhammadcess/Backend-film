...
@section('content')
    <div class="container my-4">
        <form action="{{ route('filem.perform') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-9">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <script>
                                function updateTextarea() {
                                    var isiDiv = document.getElementById('isi');
                                    var textarea = document.getElementById('content-textarea');
                                    textarea.value = isiDiv.innerText; // Set nilai textarea dengan teks dari div
                                }
                            </script>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="genre_id" id="genreSelect">
                                    <option selected="" value="">pilih Genre Filem</option>
